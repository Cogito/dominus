var helpers = {
    addedByUser: function() {
        return AlertUsers.findOne(this.vars.addedByUser_id)
    },
    ...
    title: function() {
        var user = AlertUsers.findOne(this.vars.addedByUser_id)
        if (user) {
...
Template.alert_addedToChatroom.created = function() {
    ...
    self.autorun(function() {
        if (Template.currentData()) {
            ...
            Meteor.subscribe('alertUser', Template.currentData().vars.addedByUser_id)
        }
    })
}
